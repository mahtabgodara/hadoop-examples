package com.training.hadoop.joins;
    ...
    protected void setup(Context context) throws IOException, InterruptedException {
        ...
        for(Path p : files) {
            if (p.getName().equals(IP_COUNTRY_TABLE_FILENAME)) {
                BufferedReader reader = new BufferedReader(new FileReader("//Users//mahtab.singh//projects//hadoop-examples//hadoop-examples//map_side_join_complex_key_value//nobots_ip_country_tsv.txt")); // p.toString()));
